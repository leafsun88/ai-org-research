...
“那份 JD 基本是在说：这会是长时间、高速度，你要能在 AGI timeline 逼近的紧迫感下工作；前面是很难的使命，成功会有荣誉和认可，追求 comfortable work 的人不要申请。它还说你会和 exceptional minds 一起工作，承担比普通工程岗位更大的使命，并且分享公司的成功。我确实觉得这种格式有帮助，具体措辞大多是我自己写的。它会让一些人说‘我绝对不要报名’，但也会让我们想要的人说‘对，这正是我想做的事’。” —— Lenny Rachitsky / Anton Osika, Lenny's Podcast, 2025-03-09
...
“我们公司里很多事都用 Linear，因为它真的是一个很棒的产品；我们甚至用 Linear 做 talent application tracking。我们也看过很多为招聘专门定制的工具，最后还是用了 Linear 和 FigJam，很简单。” —— Anton Osika / Lenny Rachitsky, Lenny's Podcast, 2025-03-09
