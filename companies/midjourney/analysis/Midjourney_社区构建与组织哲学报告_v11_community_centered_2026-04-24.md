...
version: v11_community_centered
date: 2026-04-24
status: draft
...
全文保留组织档案结构，但读法更集中：先解释 David Holz 为什么把 Midjourney 定义成想象力基础设施，再看小团队如何承接超大 Discord 社群，最后看社群规模如何倒逼治理和 web workspace 迁移。五个支柱是：humanist infrastructure、founder-led defaults、self-funded small team、community-as-organization、governance as product capability。
...
- 社群治理：规模越大，安全越像产品能力
- 迁移：从 Discord 社群到 Creative Workspace
...
## 7. 迁移：从 Discord 社群到 Creative Workspace
...
### Web 迁移不能破坏 Discord 的公共学习网络

Web 端不只是替代 Discord。Discord 承担的是公共学习和社群密度，Web / workspace 承担的是复杂编辑、资产管理、隐私、专业工作流和多人协作。真正的组织挑战，是把专业用户需要的自有工作台做出来，同时不把早期让 Midjourney 起飞的公共学习网络拆散。

> “我已经围绕 Discord 建好了自己的 workflow，我担心他们最后会把功能只做在 web interface 里。” —— Midjourney 社群用户评论, cited in AI Community Building Report

### Discord 是未来创作工作台的 tutorial
...
这条判断决定了 Midjourney 的产品迁移方向：保留 Discord 的公共学习网络，同时把核心创作和资产控制面收回。
...
### Inpainting 被 Discord 卡住后，平台迁移变成执行问题
...
Midjourney 从 Discord 走向自有 web/mobile，是在回收产品控制权。
