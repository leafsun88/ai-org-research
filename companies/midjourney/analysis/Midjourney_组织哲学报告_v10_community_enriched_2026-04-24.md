...
version: v10_community_enriched
date: 2026-04-24
status: draft
source_layer: external_reference + selected_evidence
focus: organization + community building
...
Midjourney 的组织哲学可以用一句话概括：公司把“扩展人类想象力”当成产品目标，也把这个目标变成组织结构。它不像传统 SaaS 公司那样先搭销售、客户成功、企业服务和多层管理，也不像纯 research lab 那样只做模型。它更像一个由 founder taste、社区反馈、GPU 供给、内容治理和创作者工作流共同组成的 creative operating system。

这个版本把“社群如何被建立起来”放回主线：Leap Motion 的失败让 David Holz 对融资、平台化和时机更谨慎；Discord 不是早期偷懒的前端，而是让用户互相学习、互相刺激、互相扩展 prompt 的产品结构；Office Hours、新手区、Daily Theme、默认公开和付费隐私共同把社区变成了 Midjourney 的组织外骨骼。

下面按组织档案展开：先讲使命和 founder 洞见，再讲领导层、招聘、社区操作系统、算力运营、产品迁移、治理风险和外部合作。偏外部客户案例、弱估算、竞争工具流水账和证据弱的二手转述不作为主线承重。

Midjourney 的五个组织支柱是：第一，humanist infrastructure，把 AI 定义成想象力引擎而不是替代艺术家的机器；第二，founder-led governance，David Holz 的默认值、审美和社会观直接塑造产品边界；第三，self-funded small team，不融资让公司避开外部增长叙事，也让组织保持低管理层；第四，community-as-organization，Discord 同时是产品入口、学习系统、反馈回路、support 层和治理现场；第五，compute-first operations，订阅现金流优先换成 GPU 供给和推理体验，而不是优先扩张销售和管理队伍。
...
- Founder 的洞见
- 领导层与组织结构
- Community-as-Organization：Midjourney 的社群建立机制
- 社区的安全治理
- 从 Discord Bot 到 Creative Workspace

## 1. 组织哲学概览

Midjourney 的公开语言很稳定：它反复把自己称为 independent research lab、small self-funded team、human infrastructure，而不是 AI startup、design SaaS 或 enterprise creative platform。这个自我定义决定了公司不急着融资、不急着开放 API、不急着把产品改造成企业采购软件，也不急着把社区拆成传统客服和营销部门。
...
Midjourney 的组织哲学有三个实际后果。

第一，它把 product taste 放在组织中心。David Holz 对默认值非常敏感：什么内容默认公开、首页奖励什么、模型偏向什么美学、哪些内容不鼓励，都会改变用户如何学习、社区如何聚集、模型如何获得反馈。

第二，它把社区视为基础设施。Discord 不是早期低成本前端而已。它让用户看到别人怎么想、怎么写 prompt、怎么从 dog 变成 space dog，再变成更奇怪的视觉语言。Midjourney 的社区在生成需求，而不是只承接需求。

第三，它把商业约束转成产品纪律。因为生成运行在云端，用户订阅直接支付推理成本，公司必须不断在算力、速度、质量和价格之间做取舍。不融资不是姿态，而是让这些取舍继续由 founder taste、用户体验和现金流决定。


## 2. 组织演进时间线与创立历史

Midjourney 的创立史不是从一个 Discord bot 开始，而是从 David Holz 对上一段公司经历的反向选择开始。Leap Motion 证明了一个很残酷的教训：技术可以非常先进，但如果硬件、平台、生态和时机没有同时成熟，组织会被融资叙事、开发者生态和平台想象拖进过早扩张。Midjourney 后来的不融资、小团队、先社区、先现金流，都能从这里找到解释。

### Leap Motion 的失败，把 Midjourney 推向不融资、小团队和正确时机

Leap Motion 融过大量资金，也做过硬件、开发者生态和平台合作，但最终没有进入大众日常。Midjourney 几乎反过来：不先搭硬件生态，不先开放 API，不先建立企业销售组织，而是先把一个能立刻使用、立刻分享、立刻付费的体验放进 Discord。这里的组织选择不是“保守”，而是 Holz 对时机和组织复杂度的重新判断。
...
### Reflection / Imagination / Coordination 是 Midjourney 的创立母题

David 离开 Leap Motion 后，真正想做的不是“AI 画图公司”，而是围绕 reflection、imagination、coordination 三个方向建立一个能长期工作的 home。图像生成只是 imagination 先出现了足够好的技术窗口。这个母题很重要，因为它解释了为什么 Midjourney 会把产品做成公共想象空间，而不是单人设计工具。
...
- CFO 交接、社区负责人变动、legal 压力上升，显示组织从 founder-led product lab 进入更复杂运营期。

### 2026：V8、Workspace 和治理压力

- V8、web workspace、personalization、style system、support system 和 API / IP 问题共同推高组织复杂度。
- Midjourney 的问题不再是能否生成好图，而是能否把创作流程、社区、算力、治理和权利管理变成稳定平台。


## 3. Founder 的洞见

### 1. Imagination over Art

> "We aim to enhance the imaginative capabilities of humanity." — Forbes, 2022/9/16

Midjourney 避开 “art” 这个词，是因为 art 会把讨论带进职业替代、版权争议和机器是否能成为艺术家的老问题。Holz 更愿意把产品定义为 imagination vehicle。这个定义让 Midjourney 不必把自己限制成设计工具、图库工具或 Photoshop 插件，而可以继续围绕“人如何生成想象”扩展。

### 2. Engine, Not Replacement

Midjourney 的基本立场是放大人的 agency，而不是把人的判断交给模型。组织上，这意味着公司需要保留大量 human-in-the-loop 的产品结构：prompt、variation、ranking、style reference、personalization、社区互学和创作者展示。模型不是独立完成作品的机器，而是让人不断选择、修正和发现偏好的引擎。
...
这条原则直接塑造了产品美学和安全边界。Midjourney 不是中性地生成“用户想要的一切”，而是在默认审美、名人生成、政治图像、色情、gore 和首页分发上不断做取舍。它的内容治理不是独立的合规部门问题，而是产品默认值的一部分。

> "The world needs more beauty... I don't think the world needs more deepfakes." — The Register, 2022/8/1

### 4. Society over Business
...
### 6. Imagining Together

这是 Midjourney 选择 Discord 而不是独立 iOS app 的根本原因。很多用户单独面对“你可以想象任何东西”时并不知道要什么；但在群体里，人会从别人的 prompt 和图像继续搭建。这种共同想象能力，是 Midjourney 社区最核心的组织资产。

> "It's kind of like a hive mind of people, super-powered with technology." — The Verge, 2022/8/2


### 7. Technology Becomes Non-technical
...
### 8. Diffusion 的机会是 taste-driven back-and-forth，不是“机器会画画”
...
### 9. Imagination vehicle 限定了 Midjourney 不该变成自动艺术家机器
...
Midjourney 没有公开完整 org chart。能从公开材料看到的是一个 founder-led、小管理层、低 title 密度的组织：David Holz 仍在产品、治理和方向判断中心；Chief of Staff、Legal、Finance、Hardware、Community / Support 作为辅助。
...
| Erik Martin | Community / Former Head of Community | 长期社区组织者。Community Club 与 SF New Tech 等公开资料显示，他曾服务 Reddit、Depop、Nike、WeWork、Teal、Commsor 等 community-powered businesses，并与 Midjourney 社区岗位相关。这个背景对应 Discord 社群、guides、moderation 和用户信任。 |
...
公开材料显示，Midjourney 的组织不是典型“创始人 + CTO + COO + VP Engineering + Sales”的公司化形状。它的中间层少，且很多关键岗位围绕约束而生：GPU 现金流需要 finance，IP 和输出风险需要 legal，hardware 需要现场工程，超大社区需要 support 和 moderation。新的 executive / project management 信号可以作为待核验项，但不在这里承重。

### 10 人团队同时背模型、社区、网页和 moderation，早期没有职能缓冲层
...
## 5. Community-as-Organization：Midjourney 的社群建立机制

Midjourney 最特殊的地方，是把社区变成组织的一部分。Discord 不只是入口，它同时承担用户意图生成、学习、support、QA、传播、moderation、审美反馈和模型改进。很多公司会拆成产品、客服、教育、研究、市场和安全团队的事，在 Midjourney 这里被压进同一个社区操作系统。

### 150 万 Discord 不是用户数，而是产品和治理实验场
...
Midjourney 用 Discord 做前端，通常被理解成临时低成本方案。但 David 的核心判断更深：大多数人单独面对“你可以想象任何东西”时不知道自己要什么；群体会让想象力在彼此想法上继续搭建。

这就是 Midjourney 社区的第一性价值。它不是把用户带到模型面前，而是让用户先在群体里发现自己可以要求什么。

早期测试里的 dog、space dog、Aztec space dog，是这个设计的原型故事。公共频道的价值不只是展示结果，而是让用户意识到自己可以要求什么：一个人的普通意图，会在另一个人的扩展、第三个人的审美跳跃里变成新的视觉语言。
...
### 为什么用 Discord？Discord能解决用户彼此互相学习的难题

Discord 给 Midjourney 提供了移动端、桌面端、图片展示、结果按钮、slash command、bot 和可扩展基础设施。更关键的是，它是协作环境。用户不只看到自己的生成结果，还能看到别人怎么写 prompt。这非常重要！
...
### 默认公开和付费隐私，把创作行为变成公共学习材料

Midjourney 的默认公开不是普通社区设置，而是学习系统的基础。新用户能看到别人如何写 prompt、如何迭代、如何把一个普通意图推进成有审美方向的图像。Stealth Mode 只有更高付费层级才开放，也让“公开生成”从默认选项变成社区规范：大多数创作先进入公共学习池，商业和隐私需求再额外付费。
...
### Daily Theme 和 Office Hours，把回访习惯和 founder 信任放进社群

Daily Theme 让用户每天有一个回来的理由，Office Hours 则让产品方向和 founder 判断直接暴露在社群里。每周 David 花数小时在 Discord Stage 回答问题，这不仅是客服或公关，而是路线图预告、产品测试、治理解释和信任积累的复合机制。
...
### Ranking system：是把社区行为转成模型改进的中间层

首先，Midjourney 的 Ranking system是什么？这是一整套把用户的审美选择收集起来，再送到产品和模型里的偏好数据系统。按 Midjourney 现在的官方文档，它至少包含三类图像任务：一类是选喜欢的图来建立 Personalization 数据；一类是给 Explore 页面的内容投票；还有一类是在新版本发布前做二选一评分，用来帮助新模型 fine-tune 和 calibrate。

社区本身就是构建产品的重要组成。这说明 Midjourney 的产品、社区和模型研发不能被拆成孤立部门。前端上的一次排序，可能同时影响用户体验、社区分发和模型训练。这也是为什么 Midjourney 的组织不是普通“research + product + community”三段式。因为社区行为本身就是研发输入。
...
Midjourney 的增长不是广告买出来的，而是公共生成本身制造了可传播事件。Colorado State Fair 把 AI art 推进艺术争议，Pope puffer coat 把 V5 的照片级真实感推给大众，关闭 free trial 则把增长边界转成品牌和治理信号。每一次出圈都在放大同一个机制：用户生成的公共图像会替公司做传播，但公司必须用治理和付费墙守住系统。
...
Midjourney 的治理不是独立后台职能，而是产品能力。它要同时处理开放社区、算力滥用、色情和暴力反馈回路、API 扩张、Hollywood IP、专业用户版权和未来 licensing。这里的难点在于：很多风险正好和用户付费价值绑定在一起。


#### 风险怎样改变组织

Midjourney 的风险不是“法务会不会赢诉讼”这么窄。真正的问题是：当公司从 Discord 社区和订阅产品走向 API、品牌授权、专业工作流和平台合作时，过去靠 founder、moderators、社区默认值和词表维持的治理方式，能不能变成可审计、可授权、可规模化的产品系统。

### API 被延后，是因为 moderation 容量还不够
...
### Support 和 moderation 要做成可持续累积的系统
...
这是从社区公司走向平台公司的关键组织转化：把原本依赖 moderators、office hours 和社区热心人的知识，沉淀成可搜索、可复用、可训练新用户的支持系统。
...
### 最理想的 moderation 不是更长禁词表，而是设立边界
...
## 7. 从 Discord Bot 到 Creative Workspace

Discord 解决了 Midjourney 的第一阶段问题：用户学习、意图生成、社交传播和低成本入口。但当 inpainting、style、personalization、asset management、video、3D、workflow 和 API 进入主线后，Midjourney 必须把更多创作控制面收回到自己的 web / mobile / workspace。

### Web 迁移的难点，是不要伤害把 Midjourney 带到这里的 Discord 社群

Web 端不是单纯替代 Discord。Discord 承担的是公共学习和社群密度，Web / workspace 承担的是复杂编辑、资产管理、隐私、专业工作流和多人协作。真正的组织挑战，是把专业用户需要的自有工作台做出来，同时不把早期让 Midjourney 起飞的公共学习网络拆散。

> “我已经围绕 Discord 建好了自己的 workflow，我担心他们最后会把功能只做在 web interface 里。” —— Midjourney 社群用户评论, cited in AI Community Building Report

### 当前 Discord 体验只是未来创作工作台的 tutorial
...
### Discord 开始卡住 inpainting，平台迁移从愿景变成执行问题
