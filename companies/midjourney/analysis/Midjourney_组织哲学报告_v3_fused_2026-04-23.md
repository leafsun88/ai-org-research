...
date: 2026-04-23
status: current
source_layer: source_note + external_reference
focus: organization
block_count: 50
---
...
**版本：** v3_fused  
**研究日期：** 2026 年 4 月  
**写作口径：** 本版以 `Midjourney_组织研究报告.md` 的组织档案框架为外层，保留其使命、组织结构图、人物、招聘、远程、AI 运营、金句、时间线与来源索引；同时把 source-note 长报告中的 50 个 evidence block 作为证据层嵌入对应章节。  
**来源说明：** 50 个 evidence block 来自 Midjourney podcast / YouTube 逐源笔记；组织结构图、人员、headcount、岗位、薪酬、remote policy 与部分时间线来自公开资料汇编，仍需逐条回源核验。  
...
这份报告有两层。第一层是组织档案：Midjourney 如何自我定义、公开组织结构能看到什么、有哪些 named leadership、招聘与远程政策如何被外部资料描绘。第二层是证据块：David Holz 原声、office hours、Power Law、Midjourney Korea、设计师和法律播客等逐源笔记，解释这些组织事实背后的运行机制。

最重要的融合判断是：Midjourney 的组织不是“神秘小团队 + 高收入”这么简单。它真正的结构是 founder taste 控方向、GPU cash discipline 控成本、Discord 社区承担学习/support/QA/moderation、逐步补 legal/finance/project-management 中间层，并在 web workspace、API、IP licensing、Meta partnership 和 professional workflow 的压力下从社区型工具升级为平台型组织。
...
**证据层：招聘/组织实践没有完整公开，但可以从信任圈、验证层和社区支持看到形状**
...
**证据层：AI 运营不是内部工具清单，而是社区反馈进入模型、产品和资源配置**
...
## 七、Community-as-Organization：Discord 是产品、学习系统和治理场

Midjourney 的 Discord 不是渠道附属物，而是一个准组织层：它负责让用户互相生成意图、降低 prompt 学习成本、承接 onboarding、暴露滥用问题，并把 moderation 压力和 feedback loop 集中到同一处。
...
## 八、从 Discord bot 到 creative workspace：产品控制权回到自己手里

Discord 解决了 Midjourney 的早期 PMF，但越复杂的创作工作流越需要自有 web / mobile / workspace。API、plugin、inpainting、asset management、production repeatability 和 style workflow 都把公司推向更强的产品控制权。
...
这些证据不完全属于 Midjourney 内部组织结构，但它们解释了 Midjourney 为什么会被市场拉向更复杂的组织能力。专业用户不只要漂亮图，而是 repeatability、brand package、campaign workflow、asset provenance 和平台分发。
...
## 十、治理与平台风险：API、IP、support 和 moderation 产品化

Midjourney 的治理问题已经从 Discord 社区规则升级为平台基础设施问题。API、Hollywood IP、Meta 级分发、品牌工作流和 professional assets 都要求它把 moderation、rights management、support 和审计产品化。
...
---
## 十二、Evolution Over Time（组织演变时间线）
...
---
## 十三、Analyst 观察与反差点（Analyst Notes）
...
1. **组织档案和逐源证据互相校正。** 外部资料能给出 named leadership、招聘、薪酬、remote policy 和 hardware 岗位，但逐源证据更能解释 Midjourney 为什么长期保持小团队、为什么 API 被按住、为什么 Discord 不是临时渠道。
2. **最需要回源核验的是结构数字。** 107-190 人、500-600M ARR、CFO/Head of Hardware/Chief of Staff/General Counsel 等信息很有价值，但不能让它们盖过 founder 原声和 office hours 证据。
3. **下一版应把 jobs / LinkedIn / official pages 做成 source notes。** 这样 v4 可以把招聘、remote policy、hardware、finance/legal 人员变化从“外部档案层”升级为“证据层”。

## 十四、参考来源（Primary Sources）
